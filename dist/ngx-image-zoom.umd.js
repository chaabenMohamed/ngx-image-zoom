(function (global, factory) {
	...
	(factory((global['ngx-image-zoom'] = {}),global.core,global.common));
...
var NgxImageZoomComponent = (function () {
    function NgxImageZoomComponent(renderer, elRef) {
        ...
        this.isInsideStaticContainer = false;
    }
    ...
    Object.defineProperty(NgxImageZoomComponent.prototype, "setisInsideStaticContainer", {
        set: /**
         * @param {?} isInStatic
         * @return {?}
         */
    ...
    function (event) {
        ...
        if (this.isInsideStaticContainer) {
            top -= (/** @type {?} */ (document.querySelector('html'))).scrollTop;
        }
    ...
    NgxImageZoomComponent.propDecorators = {
        "zoomContainer": [{ type: core.ViewChild, args: ['zoomContainer',] },],
        "imageThumbnail": [{ type: core.ViewChild, args: ['imageThumbnail',] },],
        ...
        "setMagnification": [{ type: core.Input, args: ['magnification',] },],
        "setMinZoomRatio": [{ type: core.Input, args: ['minZoomRatio',] },],
        "setMaxZoomRatio": [{ type: core.Input, args: ['maxZoomRatio',] },],
        "setScrollStepSize": [{ type: core.Input, args: ['scrollStepSize',] },],
        "setEnableLens": [{ type: core.Input, args: ['enableLens',] },],
        "setLensWidth": [{ type: core.Input, args: ['lensWidth',] },],
        "setLensHeight": [{ type: core.Input, args: ['lensHeight',] },],
        "setCircularLens": [{ type: core.Input, args: ['circularLens',] },],
        "setEnableScrollZoom": [{ type: core.Input, args: ['enableScrollZoom',] },],
        "setisInsideStaticContainer": [{ type: core.Input, args: ['isInsideStaticContainer',] },],
    };
